...
export function ShotClock({
  ...
  return (
    <motion.button
      ...
      className={`flex h-10 min-h-[44px] min-w-[60px] items-center justify-center rounded-md border-2 px-2 sm:min-w-[68px] ${fontClass} text-3xl leading-none tracking-[0.1em] ${
        low
